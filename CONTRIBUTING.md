...
Website scripts use Astro 7 and require Node.js >= 22.12.0 inside `website/`.
...
- **`packages/provider-*`** — Provider-owned discovery and parsing for Claude, Codex, Cursor, OpenCode, Hermes, Muse, Pi, and Grok Bot.
...
- **Sessions** in the UI are **Source Sessions**: raw/discovered AI coding sessions from providers such as Claude, Cursor, Codex, OpenCode, Hermes, Muse, Pi, and Grok Bot. They may or may not have a generated replay yet.
